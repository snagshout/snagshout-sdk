...
class V1GetCampaignsResponseNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    public function supportsDenormalization($data, $type, $format = null)
    {
        if ($type !== 'SellerLabs\\Snagshout\\Model\\V1GetCampaignsResponse') {
            return false;
        }
        return true;
    }
    ...
    {
        if ($data instanceof \SellerLabs\Snagshout\Model\V1GetCampaignsResponse) {
            return true;
        }
        return false;
    }
    ...
    {
        $object = new \SellerLabs\Snagshout\Model\V1GetCampaignsResponse();
        ...
        if (property_exists($data, 'data')) {
            ...
            foreach ($data->{'data'} as $value_1) {
                $values_1[] = $this->serializer->deserialize($value_1, 'SellerLabs\\Snagshout\\Model\\Campaign', 'raw', $context);
            }
